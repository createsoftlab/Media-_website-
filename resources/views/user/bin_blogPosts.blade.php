...
<head>
    ...
    <title>User - Blog Posts Bin</title>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <input type="text" id="search-input" class="form-control form-control-sm"
                                    placeholder="Search by title" oninput="filterTable()">
                            </div>
                ...
                {{-- <form method="POST" action="{{ route('admin.approve.blogPost', $post->id) }}">
                    @csrf
                    @method('PUT') --}}
                <!-- Restore  Modal -->
                @foreach ($posts as $post)
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="border-0 shadow-lg modal-content rounded-3">
                            <div class="p-5 modal-body">
                                ...
                                <form method="POST" action="{{ route('user.restore.blogPost',$post->id) }}">
                                    @csrf
                                    @method('PUT')
