                    ...
                    <div class="col-lg-12 d-flex justify-content-center align-items-center">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title text-muted">{{ $post->event_title }}</h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <form action="{{ route('user.update.eventPost',$post->id) }}" method="POST"
                                        ...
                                        <div class="container my-4">
                                           ...
                                           <!-- Image Preview Section -->
                                            <div class="mb-4" id="imagePreviewContainer"
                                                ...
                                                <div>
                                                    <img id="imagePreview"
                                                        src="{{ old('feature_image') ? asset('event_feature_image/' . old('feature_image')) : (isset($post->feature_image) ? asset('event_feature_image/' . $post->feature_image) : '#') }}"
                                        ...
                                        <div class="mb-4 col-12 row">
                                            <div class="mb-4 col-md-6 col-12 form-group">
                                                ...
                                                <div id="video1-preview" class="mt-3 video-preview">
                                                    @if($post->EventPostVideo)
                                                        <video src="{{ asset('eventVideo1/' . $post->EventPostVideo->video1) }}" controls></video>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="mb-4 col-md-6 col-12 form-group">
                                                ...
                                                <div id="video2-preview" class="mt-3 video-preview">
                                                    @if($post->EventPostVideo)
                                                        <video src="{{ asset('eventVideo2/' . $post->EventPostVideo->video2) }}" controls></video>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-4 col-12 row">
                                            <div class="mb-4 col-md-6 col-12 form-group">
                                                ...
                                                <div id="post-image-preview1" class="mt-3 image-preview">
                                                    @if($post->EventPostImage)
                                                        <img src="{{ asset('eventPost_image1/' . $post->EventPostImage->post_image1) }}" alt="Post Image 1">
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="mb-4 col-md-6 col-12 form-group">
                                                ...
                                                <div id="post-image-preview2" class="mt-3 image-preview">
                                                    @if($post->EventPostImage)
                                                        <img src="{{ asset('eventPost_image2/' . $post->EventPostImage->post_image2) }}" alt="Post Image 2">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-4 col-12 row">
                                            <div class="mb-4 col-md-6 col-12 form-group">
                                                ...
                                                <div id="post-image-preview3" class="mt-3 image-preview">
                                                    @if($post->EventPostImage)
                                                        <img src="{{ asset('eventPost_image3/' . $post->EventPostImage->post_image3) }}" alt="Post Image 3">
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="mb-4 col-md-6 col-12 form-group">
                                                ...
                                                <div id="post-image-preview4" class="mt-3 image-preview">
                                                    @if($post->EventPostImage)
                                                        <img src="{{ asset('eventPost_image4/' . $post->EventPostImage->post_image4) }}" alt="Post Image 4">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
