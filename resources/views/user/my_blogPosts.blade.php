...
<head>
    ...
    <title>User - My Blog Posts</title>
                        ...
                        <div class="text-white card-header bg-dark">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    <a class="btn btn-sm btn-danger" href="{{ route('user.draft.myblogPosts') }}">Drafts</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="border-0 shadow-lg modal-content rounded-3">
                            <div class="p-5 modal-body">
                                ...
                                <form method="POST" action="{{ route('user.delete.blogPost',$post->id) }}">
                                    @csrf
                                    @method('PUT')
