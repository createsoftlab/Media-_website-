            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">My Draft Blog Posts</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('user/dashboard')}}">Dashboard</a></li>
                                <li class="breadcrumb-item active">My Draft Posts</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="border-0 shadow-sm card">
                        <div class="text-white card-header bg-dark">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a class="btn btn-sm btn-danger" href="{{ route('user.create.blogpost') }}">Add New Blog Post</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <!-- Search Input Table -->
                                    ...
                                    <tbody id="post-table-body">
                                        @foreach ($posts as $post)
                                            <tr class="post-row" data-id="{{ $post->id }}" data-title="{{ $post->title }}">
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('user.edit.myblogPost',$post->id) }}" class="text-primary me-4" style="font-size: 1.5rem;"><i class="la la-pencil"></i></a>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="border-0 shadow-lg modal-content rounded-3">
                        <div class="p-5 modal-body">
                            ...
                            <form method="POST" action="{{ route('user.delete.draft',$post->id) }}">
                                @csrf
                                @method('delete')
