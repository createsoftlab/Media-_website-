                ...
                <div class="content container-fluid">
							...
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										<h3>{{ $pendingEventPosts }}</h3>
										<span>Pending <br>Blog Posts</span>
									</div>
								</div>
							</div>
						</div>
                    ...
                    <div class="row">
                            ...
                            <div class="card flex-fill">
                                <div class="card-body">
                                    ...
                                    <div class="text-center load-more">
                                        <a class="text-dark" href="{{ route('user.myblogPosts') }}">Load More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 d-flex">
                            <div class="card flex-fill">
                                <div class="card-body">
                                    <h4 class="card-title">Latest Event Posts</h4>
                                    ...
                                    @endforeach
                                    <div class="text-center load-more">
                                        <a class="text-dark" href="{{ route('user.myEventPosts') }}">Load More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
