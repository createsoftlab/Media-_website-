...
<head>
    ...
    <title>User - Draft Event posts</title>
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">My Draft Event Posts</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('user/dashboard')}}">Dashboard</a></li>
                                <li class="breadcrumb-item active">My Event Posts</li>
                            </ul>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody id="post-table-body">
                                        @foreach ($posts as $post)
                                            <tr class="post-row" data-id="{{ $post->id }}" data-title="{{ $post->title }}">
                                                ...
                                                <td class="text-center">
                                                    <span class="badge bg-secondary custom-badge" style="font-size: 0.8rem; padding: 0.6rem 0.6rem; color:white">Draft</span>
                                                </td>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="border-0 shadow-lg modal-content rounded-3">
                        <div class="p-5 modal-body">
                            ...
                            <form method="POST" action="{{ route('user.delete.draftEvent',$post->id) }}">
                                @csrf
                                @method('delete')
