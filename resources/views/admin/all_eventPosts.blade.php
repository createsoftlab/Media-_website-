...
<head>
    ...
    <title>Admin- All Event Posts</title>
            ...
            <div class="content container-fluid">
                 ...
                 <div class="page-header">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-md-6">
                            <h3 class="page-title">All Event Posts</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">All Events Posts</li>
                            </ul>
                        </div>
                                    ...
                                    <tbody id="post-table-body">
                                        @foreach ($posts as $post)
                                            <tr class="post-row" data-id="{{ $post->id }}" data-title="{{ $post->title }}">
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('admin.view.eventPost',$post->id) }}"
                                                        class="btn btn-outline-success btn-sm">View</a>
                                                </td>
                                                <td class="text-center">
                                                    <a href="{{ route('admin.view.eventPost',$post->id) }}" class="text-primary me-4" style="font-size: 1.5rem;"><i class="la la-pencil"></i></a>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="border-0 shadow-lg modal-content rounded-3">
                            <div class="p-5 modal-body">
                                ...
                                <form method="POST" action="{{ route('admin.delete.eventPost',$post->id) }}">
                                    @csrf
                                    @method('PUT')
