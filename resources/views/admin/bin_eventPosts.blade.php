...
<head>
    ...
    <title>Admin- Bin Event Posts</title>
            ...
            <div class="content container-fluid">
                 ...
                 <div class="page-header">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-md-6">
                            <h3 class="page-title">Bin Event Posts</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Bin Events Posts</li>
                            </ul>
                        </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="border-0 shadow-lg modal-content rounded-3">
                            <div class="p-5 modal-body">
                                ...
                                <form method="POST" action="{{ route('admin.restore.eventPost',$post->id) }}">
                                    @csrf
                                    @method('PUT')
