                                                    ...
                                                    <td class="text-right">
                                                        <div class="dropdown dropdown-action">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                @if (!$comment->approved)
                                                                    <form action="{{ route('comments.approve', $comment->id) }}" method="POST" class="approve-form">
                                                                        @csrf
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="border-0 shadow-lg modal-content rounded-3">
                                <div class="p-5 modal-body">
                                    ...
                                    <form method="POST" action="{{ route('comments.delete', $comm->id) }}">
                                        @csrf
                                        @method('DELETE')
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        const commentsPerPage = 10; // Adjust the number of comments per page
