...
<head>
    ...
    <title>Admin - All Blog Posts</title>
                                ...
                                <table class="table mb-0 table-bordered table-striped table-hover">
                                    ...
                                    <tbody id="post-table-body">
                                        ...
                                        <tr class="post-row" data-id="{{ $post->id }}" data-title="{{ $post->title }}"
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.view.blogPost',$post->id) }}"
                                                    class="btn btn-outline-success btn-sm">View</a>
                                            </td>
                                            <td class="text-center">
                                                <a href="#" data-toggle="modal" data-target="#Delete_Modal_{{ $post->id }}" class="text-danger" style="font-size: 1.5rem;"><i
