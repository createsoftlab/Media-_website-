...
<!-- Mirrored from new.axilthemes.com/demo/template/blogar/post-format-gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Dec 2024 07:24:08 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Post Format Gallery || Blogar </title>
                        ...
                        <div class="axil-post-details">
                            ...
                            <figure class="wp-block-image">
                                <div class="post-gallery-activation axil-slick-arrow arrow-between-side">
                                    ...
                                    <div class="post-images">
                                        <img src="{{asset('home/assets/images/post-single/post-single-05.jpg')}}" alt="Post Images">
                                    </div>
                                    <div class="post-images">
                                        <img src="{{asset('home/assets/images/post-single/post-single-02.jpg')}}" alt="Post Images">
                                    </div>
