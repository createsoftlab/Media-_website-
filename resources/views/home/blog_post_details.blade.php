...
<head>
    ...
    <title>{{ $post->meta_title ?? 'Default Title' }} || Blog Posts</title>
...
<body>
    <div class="main-wrapper">
                        ...
                        <div class="content-block">
                            ...
                            <div class="post-content">
                                ...
                                <div class="post-meta-wrapper">
                                    <div class="post-meta">
                                        <div class="post-author-avatar" style="border-radius: 50%; overflow: hidden; width: 100px; height: 100px;">
                                            @if($post->user->pro_image)
                                            <img src="{{ asset('pro_pic/'.$post->user->pro_image) }}" alt="Author Image" width="100" height="100" style="object-fit: cover; border-radius: 50%; aspect-ratio: 1 / 1;">
                                            @else
                                            <i class="la la-user" style="font-size: 40px; color: #fff; background-color: #4CAF50; border-radius: 50%; width: 100px; height: 100px; display: flex; justify-content: center; align-items: center; transition: all 0.3s ease-in-out;" onmouseover="this.style.backgroundColor='#009688'" onmouseout="this.style.backgroundColor='#4CAF50'"></i>
                                            @endif
                                        </div>
                                        <div class="content">
                                    ...
                                    <ul class="social-share-transparent justify-content-end">
                                        ...
                                        <li><a href="https://www.linkedin.com/shareArticle?mini=true&url={{ urlencode(url()->current()) }}&title={{ urlencode($post->title) }}" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- End Post Content  -->
        ...
        <div class="iframe-preview">
            <iframe src="{{ route('book.blogPost.details',$post->id)}}" width="100%" height="850px" style="border: none;"></iframe>
        </div>
        ...
        <div class="axil-instagram-area axil-section-gap bg-color-WHITE">
            <div class="container">
                ...
                <div class="mt-4 row justify-content-center">
                    ...
                    @if($post->PostImage && $post->PostImage->post_image1)
                    <div class="mb-4 col-lg-3 col-md-6 col-sm-12">
                        <a href="#">
                            <img src="{{ asset('post_image1/' . $post->PostImage->post_image1) }}" alt="Post Image 1" class="img-fluid" style="height: 300px; object-fit: cover;">
                        </a>
                    </div>
                    @endif

                    <!-- Check if post_image2 exists and display if true -->
                    @if($post->PostImage && $post->PostImage->post_image2)
                    <div class="mb-4 col-lg-3 col-md-6 col-sm-12">
                        <a href="#">
                            <img src="{{ asset('post_image2/' . $post->PostImage->post_image2) }}" alt="Post Image 2" class="img-fluid" style="height: 300px; object-fit: cover;">
                        </a>
                    </div>
                    @endif

                    <!-- Check if post_image3 exists and display if true -->
                    @if($post->PostImage && $post->PostImage->post_image3)
                    <div class="mb-4 col-lg-3 col-md-6 col-sm-12">
                        <a href="#">
                            <img src="{{ asset('post_image3/' . $post->PostImage->post_image3) }}" alt="Post Image 3" class="img-fluid" style="height: 300px; object-fit: cover;">
                        </a>
                    </div>
                    @endif

                    <!-- Check if post_image4 exists and display if true -->
                    @if($post->PostImage && $post->PostImage->post_image4)
                    <div class="mb-4 col-lg-3 col-md-6 col-sm-12">
                        <a href="#">
                            <img src="{{ asset('post_image4/' . $post->PostImage->post_image4) }}" alt="Post Image 4" class="img-fluid" style="height: 300px; object-fit: cover;">
                        </a>
                    </div>
                    @endif
                </div>
        ...
        <div class="axil-more-stories-area axil-section-gap bg-color-grey">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    @if($post->PostVideo && $post->PostVideo->video1)
                    <div class="mb-4 col-lg-6 col-md-8 col-sm-10 col-12">
                        <div class="post-stories content-block mt--30">
                            <div class="text-center post-content">
                                <iframe src="{{ asset('video1/' . $post->PostVideo->video1) }}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="video-iframe" style="width: 100%; height: 300px;"></iframe>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    @if($post->PostVideo && $post->PostVideo->video2)
                    <div class="mb-4 col-lg-6 col-md-8 col-sm-10 col-12">
                        <div class="post-stories content-block mt--30">
                            <div class="text-center post-content">
                                <iframe src="{{ asset('video2/' . $post->PostVideo->video2) }}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="video-iframe" style="width: 100%; height: 300px;"></iframe>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-lg-8">
                        <div class="axil-post-details">
                            ...
                            <div class="social-share-block">
                                <div>
                                    <div class="post-view" style="display: inline-block; margin-right: 20px;">
                                        <i class="fal fa-eye" id="view-icon-{{ $post->id }}" style="color: {{ $post->views_count ? 'blue' : 'gray' }};"></i>
                                        <span id="view-count-{{ $post->id }}" style="color: {{ $post->views_count ? 'blue' : 'gray' }}; margin-left: 5px;">
                                            @php
                                    ...
                                    <div class="post-like" style="display: inline-block;">
                                        <form id="like-form-{{ $post->id }}" action="{{ route('posts.like', ['post' => $post->id]) }}" method="POST" style="display: none;">
                                            @csrf
                                        </form>
                                        <button type="button" class="like-button" id="like-button-{{ $post->id }}" style="background: none; border: none; cursor: pointer;">
                                            <i class="fal fa-thumbs-up" id="like-icon-{{ $post->id }}" style="color: {{ $post->likes->where('user_id', auth()->id())->where('liked', true)->count() || $post->likes->where('ip_address', request()->ip())->count() ? 'blue' : 'gray' }};"></i>
                                            <span id="like-count-{{ $post->id }}" style="color: {{ $post->likes->where('user_id', auth()->id())->where('liked', true)->count() || $post->likes->where('ip_address', request()->ip())->count() ? 'blue' : 'gray' }}; margin-left: 5px;">
                                                @php
                                                $likeCount = $post->likes->where('liked', true)->count();
                                                if ($likeCount >= 1000) {
                                                echo number_format($likeCount / 1000, 1) . 'k';
                                                } else {
                                                echo $likeCount;
                                                }
                                                @endphp
                                        ...
                                        fetch(form.action, {
                                            ...
                                            .then(data => {
                                                if (data.success) {
                                                    ...
                                                    likeIcon.style.color = liked ? 'blue' : 'gray';
                            ...
                            <div class="about-author">
                                <div class="media">
                                    <div class="thumbnail">
                                        <a href="#">
                                            @if($post->user->pro_image)
                                            <img src="{{asset('pro_pic/'.$post->user->pro_image)}}" alt="Author Images" width="60" height="60" style="object-fit: cover; border-radius: 50%; aspect-ratio: 1 / 1;">
                                            @else
                                            <img src="{{asset('admin/assets/img/user.jpg')}}" alt="Author Images" width="80" height="80">
                                            @endif
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <div class="author-info">
                                            <h5 class="title">
                                                <a class="hover-flip-item-wrapper" href="#">
                                                    <span class="hover-flip-item">
                                                        <span data-text="{{ $post->user->name }}">{{ $post->user->name
                                                            }}</span>
                                                    </span>
                                                </a>
                                            </h5>
                            ...
                            <div class="axil-comment-area">
                                        ...
                                        <div class="row row--10">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" id="name" required style="outline: 2px solid #b862bc; outline-offset: 2px; padding: 10px; border-radius: 5px; font-size: 14px; border: 1px solid #ccc; width: 100%;">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="email">Your Email</label>
                                                    <input type="email" name="email" id="email" required style="outline: 2px solid #b862bc; outline-offset: 2px; padding: 10px; border-radius: 5px; font-size: 14px; border: 1px solid #ccc; width: 100%;">
                                                </div>
                                            </div>
                                            @else
                                            <!-- If user is logged in, these fields will be hidden -->
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="comment" id="comm" rows="5" required style="outline: 2px solid #b862bc; outline-offset: 2px; padding: 10px; border-radius: 5px; font-size: 14px; border: 1px solid #ccc; width: 100%;"></textarea>
                                                </div>
                                            </div>

                                            <div class="col-lg-12">
                                                <div class="form-submit cerchio">
                                                    <button name="submit" type="submit" id="submit" class="axil-button button-rounded">
                                                        Post Comment
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="comment-body">
                                                <div class="single-comment">
                                                    <div class="comment-img">
                                                        ...
                                                        <img src="{{ asset('pro_pic/' . $comment->user->pro_image) }}" alt="Author Image" width="50" height="50" style="object-fit: cover; border-radius: 50%; aspect-ratio: 1 / 1;">
                                                        @else
                                                        <!-- Generate initials for guest or user without a profile image -->
                                                        <div class="avatar-initials" style="width: 50px; height: 50px; border-radius: 50%; background-color: #b862bc; color: #fff; display: flex; align-items: center; justify-content: center; font-size: 18px; font-weight: bold; text-transform: uppercase;">
                                                            {{ $comment->user ? substr($comment->user->name, 0, 1) . substr(strrchr($comment->user->name, ' '), 1, 1) :
                                                                substr($comment->name, 0, 1) . substr(strrchr($comment->name, ' '), 1, 1) }}
                                                        </div>
                                                        @endif
                                                    ...
                                                    <div class="comment-inner">
                                                        <h6 class="commenter">
                                                            <a class="hover-flip-item-wrapper" href="#">
                                                                <span class="hover-flip-item">
                                                                    <span data-text="{{ $comment->user ? $comment->user->name : $comment->name }}">
                                                        ...
                                                        <div class="comment-meta">
                                                            ...
                                                            <div class="reply-edit">
                                                                <div class="reply">
                                                                    @auth
                                                                    <a class="comment-reply-link hover-flip-item-wrapper" href="javascript:void(0);" onclick="toggleReplyForm({{ $comment->id }})">
                                                                        <span class="hover-flip-item">
                                                ...
                                                <li class="comment" id="reply-{{ $reply->id }}">
                                                    <div class="comment-body">
                                                        <div class="single-comment">
                                                            ...
                                                            alt="Author Image" width="50" height="50" style="object-fit: cover; border-radius: 50%; aspect-ratio: 1 / 1;">
                                                        </div> --}}
                                                        <div class="comment-img">
                                                            @if ($reply->user && $reply->user->pro_image)
                                                            <!-- Display user profile image if available -->
                                                            <img src="{{ asset('pro_pic/' . $reply->user->pro_image) }}" alt="Author Image" width="50" height="50" style="object-fit: cover; border-radius: 50%; aspect-ratio: 1 / 1;">
                                                            @else
                                                            <!-- Generate initials for guest or user without a profile image -->
                                                            <div class="avatar-initials" style="width: 50px; height: 50px; border-radius: 50%; background-color: #b862bc; color: #fff; display: flex; align-items: center; justify-content: center; font-size: 18px; font-weight: bold; text-transform: uppercase;">
                                                                {{ $reply->user
                                                                            ? substr($reply->user->name, 0, 1) . substr(strrchr($reply->user->name, ' '), 1, 1)
                                                                            : substr($reply->name, 0, 1) . substr(strrchr($reply->name, ' '), 1, 1) }}
                                                            </div>
                                                            @endif
                                                        </div>
                                                        ...
                                                        <div class="comment-inner">
                                                            <h6 class="commenter">
                                                                <a class="hover-flip-item-wrapper" href="#">
                                                                    <span class="hover-flip-item">
                                                                        <span data-text="{{ $reply->user->name }}">{{
                                ...
                                @auth
                                <div id="reply-form-{{ $comment->id }}" class="comment-respond" style="display: none;">
                                    <form class="replyForm" action="{{ route('storeReply', $comment->id) }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="row row--10">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="reply" rows="5" required style="outline: 2px solid #b862bc; outline-offset: 2px; padding: 10px; border-radius: 5px; font-size: 14px; border: 1px solid #ccc; width: 100%;"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-submit cerchio">
                                                    <input type="submit" value="Post Reply" class="axil-button button-rounded">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
...
============================================ -->
    ...
    <script>
        function toggleReplyForm(commentId) {
            // Find the reply form for the specific comment and toggle visibility
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelectorAll('.like-button').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    console.log(`Post ID: ${postId}, Liked: ${isLiked}`); // Debugging log
                    ...
                    fetch(`/eventPosts/${postId}/like`, {
                        ...
                        .then(data => {
                            ...
                            icon.style.color = data.liked ? 'blue' : 'gray';

                            const formattedCount = data.likeCount >= 1000 ? (data.likeCount / 1000).toFixed(1) + 'k' : data.likeCount;
                            likeCountElement.textContent = formattedCount;
                        })
                        .catch(error => {
