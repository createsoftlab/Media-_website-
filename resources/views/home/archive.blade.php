...
<!-- Mirrored from new.axilthemes.com/demo/template/blogar/archive.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Dec 2024 07:24:09 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Archive || Blogar </title>
                ...
                <div class="row">
                    <div class="col-lg-8 col-xl-8">
                        ...
                        <div class="content-block post-list-view mt--30">
                            <div class="post-thumbnail">
                                <a href="{{url('/post_details')}}">
                                    <img src="{{asset('home/assets/images/post-images/post-list-01.jpg')}}" alt="Post Images">
                                </a>
                                <a class="video-popup icon-color-secondary size-medium position-top-center" href="{{url('/post_details')}}"><span class="play-icon"></span></a>
                            </div>
                            <div class="post-content">
                                ...
                                <h4 class="title"><a href="{{url('/post_details')}}">The 1 tool that helps remote teams collaborate better</a></h4>
                        ...
                        <div class="content-block post-list-view mt--30">
                            <div class="post-thumbnail">
                                <a href="{{url('/post_details')}}">
                                    <img src="{{asset('home/assets/images/post-images/post-list-02.jpg')}}" alt="Post Images">
                                </a>
                            </div>
                            <div class="post-content">
                                <div class="post-cat">
                                ...
                                <h4 class="title"><a href="{{url('/post_details')}}">Traditional design won’t save us in the COVID-19 era</a></h4>
                                <div class="post-meta-wrapper">
                                    <div class="post-meta">
                                        <div class="content">
                                            <h6 class="post-author-name">
                        ...
                        <div class="content-block post-list-view mt--30">
                            <div class="post-thumbnail">
                                <a href="{{url('/post_details')}}">
                                    <img src="{{asset('home/assets/images/post-images/post-list-03.jpg')}}" alt="Post Images">
                                </a>
                            </div>
                            <div class="post-content">
                                <div class="post-cat">
                                ...
                                <h4 class="title"><a href="{{url('/post_details')}}">Security isn’t just a technology problem it’s about design, too</a></h4>
                                <div class="post-meta-wrapper">
                                    <div class="post-meta">
                                        <div class="content">
                                            <h6 class="post-author-name">
                        ...
                        <div class="content-block post-list-view mt--30">
                            <div class="post-thumbnail">
                                <a href="{{url('/post_details')}}">
                                    <img src="{{asset('home/assets/images/post-images/post-list-04.jpg')}}" alt="Post Images">
                                </a>
                            </div>
                            <div class="post-content">
                                <div class="post-cat">
                                ...
                                <h4 class="title"><a href="{{url('/post_details')}}">New: Freehand Templates, built for the whole team</a></h4>
                                <div class="post-meta-wrapper">
                                    <div class="post-meta">
                                        <div class="content">
                                            <h6 class="post-author-name">
                        ...
                        <div class="content-block post-list-view mt--30">
                            <div class="post-thumbnail">
                                <a href="{{url('/post_details')}}">
                                    <img src="{{asset('home/assets/images/post-images/post-list-05.jpg')}}" alt="Post Images">
                                </a>
                            </div>
                            <div class="post-content">
                                <div class="post-cat">
                                ...
                                <h4 class="title"><a href="{{url('/post_details')}}">Get Ready To Up Your Creative Game With The New DJI Mavic Air 2</a></h4>
                                <div class="post-meta-wrapper">
                                    <div class="post-meta">
                                        <div class="content">
                                            <h6 class="post-author-name">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-9 col-md-12">
                            <div class="copyright-left">
                                <div class="logo">
                                    <a href="{{url('/')}}">
                                        <img class="dark-logo" src="{{asset('home/assets/images/logo/logo-black.png')}}" alt="Logo Images">
                                        <img class="light-logo" src="{{asset('home/assets/images/logo/logo-white2.png')}}" alt="Logo Images">
                                    </a>
                                </div>
