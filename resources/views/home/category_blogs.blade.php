...
<head>
    ...
    <title>Category || Post Details || Blogar</title>
                        ...
                        <div class="blogpost-container">
                            <div class="content-block post-list-view mt--30">
                                <div class="post-thumbnail">
                                    <a href="{{ route('blogPost.details', ['id' => $post->id, 'slug' => $post->slug]) }}">
                                        <img src="{{ asset('feature_image/' . $post->feature_image) }}"
                                            alt="Post Images" style="width: 250px; height: 250px; object-fit: cover;">
                                    </a>
                                </div>
                                <div class="post-content">
                                    ...
                                    <h4 class="title"><a
                                            href="{{ route('blogPost.details', ['id' => $post->id, 'slug' => $post->slug]) }}">{{$post->title}}</a></h4>
                            ...
                            <div class="axil-single-widget widget widget_postlist mb--30">
                                ...
                                <div class="post-medium-block">
                                    ...
                                    <div class="content-block post-medium mb--20">
                                        <div class="post-thumbnail">
                                            <a href="{{ route('blogPost.details', ['id' => $post->id, 'slug' => $post->slug]) }}">
                                                <img src="{{ asset('feature_image/'.$latestPost->feature_image) }}"
                                                    alt="Post Images"
                            ...
                            <div class="axil-single-widget widget widget_blog mb--30">
                                ...
                                <div class="blog-post">
                                    ...
                                    <a class="axil-button button-rounded color-secondary-alt"
                                        href="{{ route('create.post') }}">Post Blog</a>
                                    @else
                                    <a class="axil-button button-rounded color-secondary-alt"
                                    ...
                                    @else
                                    <a class="axil-button button-rounded color-secondary-alt"
                                        href="{{ route('register') }}">Post Blog</a>
                                    @endif
                                </div>
                                <!-- End Single Post  -->
                            </div>
