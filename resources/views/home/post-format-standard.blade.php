...
<!-- Mirrored from new.axilthemes.com/demo/template/blogar/post-format-standard.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Dec 2024 07:24:03 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Post Format Standard || Blogar </title>
                    ...
                    <div class="col-lg-8">
                        <div class="axil-post-details">
                            ...
                            <figure class="wp-block-image">
                                <img src="{{asset('home/assets/images/post-single/post-single-02.jpg')}}" alt="Post Images">
                            ...
                            <figure class="wp-block-image">
                                <img src="{{asset('home/assets/images/post-single/post-single-03.jpg')}}" alt="Post Images">
                                <figcaption>The Apple Design Award trophy, created by the Apple Design team, is a symbol
                                    of achievement and excellence.</figcaption>
                            </figure>
                            <h2>Apple Design Award Winners: Apps</h2>
                            ...
                            <figure class="wp-block-image">
                                <img src="{{asset('home/assets/images/post-single/post-single-04.jpg')}}" alt="Post Images">
                                <figcaption>The Apple Design Award trophy, created by the Apple Design team, is a symbol
                                    of achievement and excellence.</figcaption>
                            </figure>
                                ...
                                <div class="axil-total-comment-post">
                                    ...
                                    <div class="cerchio">
                                        <div class="add-comment-button">
                                            <a class="axil-button button-rounded" href="{{url('/post_details')}}" tabindex="0"><span>Add Your Comment</span></a>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar-inner">
                            ...
                            <div class="axil-single-widget widget widget_instagram mb--30">
                                ...
                                <ul class="instagram-post-list-wrapper">
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{asset('home/assets/images/small-images/instagram-01.jpg')}}" alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{asset('home/assets/images/small-images/instagram-02.jpg')}}" alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{asset('home/assets/images/small-images/instagram-03.jpg')}}" alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{asset('home/assets/images/small-images/instagram-04.jpg')}}" alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{asset('home/assets/images/small-images/instagram-05.jpg')}}" alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{asset('home/assets/images/small-images/instagram-06.jpg')}}" alt="Instagram Images">
                                        </a>
                                    </li>
                                </ul>
                                <!-- End Post List  -->
                                ...
                                <div class="video-post-wrapepr">
                                    ...
                                    <div class="content-block image-rounded">
                                        <div class="post-content">
                                            <div class="post-thumbnail">
                                                <a href="{{url('/post_details')}}">
                                                    <img src="{{asset('home/assets/images/post-single/post-md-01.jpg')}}" alt="Post Images">
                                                </a>
                                                <a class="video-popup size-medium icon-color-secondary position-top-center" href="{{url('/post_details')}}"><span class="play-icon"></span></a>
                                            </div>
                                            <h6 class="title mt--10"><a href="{{url('/post_details')}}">I built my own camera with a Raspberry Pi 4</a>
                                            </h6>
                                        </div>
                                    ...
                                    <div class="content-block image-rounded mt--20">
                                        <div class="post-content">
                                            <div class="post-thumbnail">
                                                <a href="{{url('/post_details')}}">
                                                    <img src="{{asset('home/assets/images/post-single/post-md-02.jpg')}}" alt="Post Images">
                                                </a>
                                                <a class="video-popup size-medium icon-color-secondary position-top-center" href="{{url('/post_details')}}"><span class="play-icon"></span></a>
                                            </div>
                                            <h6 class="title mt--10"><a href="{{url('/post_details')}}">A rocket launch can’t unite us until the space
                                    ...
                                    <div class="content-block image-rounded mt--20">
                                        <div class="post-content">
                                            <div class="post-thumbnail">
                                                <a href="{{url('/post_details')}}">
                                                    <img src="{{asset('home/assets/images/post-single/post-md-03.jpg')}}" alt="Post Images">
                                                </a>
                                            ...
                                            <h6 class="title mt--10"><a href="{{url('/post_details')}}"> With iOS 14, Apple is finally letting the
                            ...
                            <div class="axil-banner">
                                <div class="thumbnail">
                                    <a href="#">
                                        <img class="w-100" src="{{asset('home/')}}assets/images/add-banner/banner-02.png" alt="Banner Images">
                                    </a>
                                </div>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="post-stories content-block mt--30">
                        ...
                        <div class="post-content">
                            ...
                            <h5 class="title"><a href="{{url('/post_details')}}">Microsoft and Bridgestone launch real-time
                                    tire</a></h5>
                        </div>
                    </div>
                    <!-- End Post List  -->
...
<!-- Mirrored from new.axilthemes.com/demo/template/blogar/post-format-standard.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Dec 2024 07:24:07 GMT -->
</html>
